<?php 
    ...
    move_uploaded_file($orig_file,$destination);
     ...
     // exit();
      ...
      $isSuccess = $crud->insertPatients($fname, $lname, $dob, $email, $contact, $gender, $homeaddress, $destination);
      $genderName = $crud->getGenderById($gender);
      
      if($isSuccess){
        SendEmail::SendMail($email, 'Welcome to the 2022 Ner Medical Center', 'You have registered successfully for this year\'s Ner Medical Center');
...
?>
    ...
    <img src="<?php echo $destination; ?>" class="rounded-circle" alt="..." style="width: 15%; height 20%;" />
        ...
        <div class="card" style="width: 18rem;">
            ...
            <p class="card-text">
                    Home Address: <?php echo $_POST['homeaddress'];?>
            </p>
